  ...
  return (
    <div className="app">
      ...
      <section id="home" className="hero">
        ...
        <img src="/images/hero.jpg" alt="Runners" className="hero__img" />
      ...
      <section id="pillars" className="pillars">
        <div className="container">
          {PILLARS.map((p, i) => (
            <div
              key={i}
              className={`pillar ${i % 2 === 1 ? "pillar--reverse" : ""}`}
            >
            ...
            {TESTIMONIALS.map((t, i) => (
              <div
                ...
                className={`testi__card ${
                  i === activeTestimonial ? "testi__card--active" : ""
                }`}
              >
          ...
          <div className="article-grid">
            <div className="article-card">
              ...
              <div className="article-card__body">
                ...
                <a href="#articles" className="btn btn--text">
                  更多資訊 →
                </a>
              </div>
            </div>
      ...
      <footer id="contact" className="footer">
        <div className="container footer__inner">
          <div className="footer__brand">
            <img
              src="/images/ProRC-logo.png"
              alt="Pro Running Club"
        ...
        <div className="footer__bottom">
          <p>
            © {new Date().getFullYear()} 長跑達人 Pro-Running Club. All rights
            reserved.
          </p>
        </div>
      </footer>
